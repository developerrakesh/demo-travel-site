...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "demo-travel-site:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdemo_travel_site"] = self["webpackChunkdemo_travel_site"] || [];
...
var RevealOnScroll = /*#__PURE__*/function () {
  function RevealOnScroll(items, positionToShow) {
  ...
  RevealOnScroll_createClass(RevealOnScroll, [{
    ...
    value: function calcCaller() {
      ...
      this.itemsToReveal.forEach(function (el) {
        if (!el.isRevealed) {
          _this2.showIfScrolledTo(el);
        }
      });
    }
  }, {
    key: "showIfScrolledTo",
    value: function showIfScrolledTo(el) {
...
var StickyHeader = /*#__PURE__*/function () {
  ...
  StickyHeader_createClass(StickyHeader, [{
    ...
    value: function runOnScroll() {
      ...
      this.pagesSections.forEach(function (el) {
...
new modules_RevealOnScroll(document.querySelectorAll('.testimonial'), 65);
var stikcyHeader = new modules_StickyHeader();
var modal;
document.querySelectorAll('.open-modal').forEach(function (el) {
  el.addEventListener('click', function (evt) {
    ...
    if (typeof modal == 'undefined') {
      __webpack_require__.e(/* import() | modal */ 582).then(__webpack_require__.bind(__webpack_require__, 765)).then(function (x) {
        modal = new x["default"]();
        setTimeout(function () {
          return modal.openModal();
        }, 50);
      })["catch"](function () {
        return console.log('Problem in Loading Modal');
      });
    } else {
      modal.openModal();
    }
